...
public class CityListTest {
    ...
    public void testAdd() {
        ...
        assertEquals(2, cityList.getCities(1).size());//2 functions for testing
    ...
    public void testdelete() {
        ...
        assertTrue(!cityList.getCities(1).contains(city));//assertequals diyeo check kora jwto
    }
    ...
    public void testcount(){
        ...
        City city = new City("Chapai", "Rajshahi");
        cityList.add(city);
        assertEquals(1,cityList.count());
        City city1 = new City("Bogura", "Rajshahi");
        cityList.add(city1);
